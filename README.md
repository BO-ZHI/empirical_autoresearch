...
This repository was prepared with an OpenAI coding agent: Codex. The agent was prompted to design an empirical autoresearch workflow, implement a controller and evaluation harness, and run a sanitized forward test.
